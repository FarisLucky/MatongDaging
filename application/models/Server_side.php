...
class Server_side extends CI_Model
{
    ...
    public function makeQuery($column_orders,$table,$search,$order,$column_where)
    {
    ...
    public function makeDataTables($column_orders,$table,$search,$order,$column_where=null)
    {
        ...
        $ord = $order;
        $where = $column_where;
        $this->makeQuery($column,$tbl,$src,$ord,$where);
    ...
    function get_filtered_datas($column_orders,$table,$search,$order,$column_where=null){  
        $this->makeQuery($column_orders,$table,$search,$order,$column_where);  
        $query = $this->db->get();  
