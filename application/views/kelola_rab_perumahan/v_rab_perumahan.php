                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <a href="<?= base_url() ?>kelola_rab_perumahan/tambah"class="btn btn-info btn-sm float-right">Tambah</a>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <?php 
                                $no = 1;
                                foreach($kelola_rab_perumahan as $k){ 
                                ?>
                                <tr>
                                    <td><?php echo $no++ ?></td>
                                    ...
                                    <td>
                                    <a href="<?= base_url() .'kelola_rab_perumahan/edit'?>/<?= $k->id_detail ?>" class="btn btn-primary" class="btn btn-primary">Edit</a>
                                    <a href="<?= base_url() .'kelola_rab_perumahan/hapus'?>/<?= $k->id_detail?>" class="btn btn-danger" class="btn btn-danger">Delete</a>
                                    </td>
