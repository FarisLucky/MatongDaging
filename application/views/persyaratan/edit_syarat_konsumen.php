...
<div class="container">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body p-4">
                <form action="<?php echo base_url("persyaratankonsumen/coreubah"); ?>" method="post">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <select name="poin" class="form form-control">
                                    ...
                                    <option value="ps" <?php echo ($persyaratan->poin_penting == "ps") ? "selected" : ""; ?>>Penting Sekali</option>
                                    <option value="p" <?php echo ($persyaratan->poin_penting == "p") ? "selected" : ""; ?>>Penting</option>
                                    <option value="s" <?php echo ($persyaratan->poin_penting == "s") ? "selected" : ""; ?>>Sedang</option>
                                    <option value="tp" <?php echo ($persyaratan->poin_penting == "tp") ? "selected" : ""; ?>>Tidak Penting</option>
                                </select>
