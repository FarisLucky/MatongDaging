                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <a href="<?= base_url() ?>persyaratankonsumen/tambah"class="btn btn-info btn-sm float-right"><i class="fa fa-plus"></i>Tambah</a>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                                ...
                                <table class="table table-hover table-striped table-bordered" id="tbl_syarat_unit">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= base_url('persyaratankonsumen/ubah/'.$p->id_sasaran) ?>" class="btn btn-sm btn-primary" ><i class="fa fa-edit"></i>Ubah</a>
