            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr>
                        <form action="<?php echo base_url() . 'index.php/follow_calon_konsumen/tambah_data'; ?>" method="post">
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="input_keterangan" name="val_keterangan" value="<?= set_value('val_keterangan') ?>" placeholder="Masukan Keterangan" class="form-control <?= form_error('val_keterangan') ? 'is-invalid' : '' ?> ">
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name='val_hasil' id="input_hasil" class="form-control <?= form_error('val_hasil') ? 'is-invalid' : '' ?>">
                                                    ...
                                                    <option value="Setuju" <?= set_value('val_hasil') == 'Setuju' ? 'selected' : '' ?>>Setuju</option>
                                                    <option value="Tidak setuju" <?= set_value('val_hasil') == 'Tidak setuju' ? 'selected' : '' ?>>Tidak Setuju</option>
                                                </select>
                                                <div class="invalid-feedback">
