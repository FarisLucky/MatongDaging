<div class="content-wrapper" id="view_pemasukan">
    <div class="container">
        <div class="card">
            <div class="card-body p-4">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3 pt-4 px-0 mx-0">
                       ...
                       <button type="submit" formaction="<?= base_url('laporanpemasukan/printall') ?>" class="btn btn-warning"><i class="fa fa-print"></i>Print</button>
                    </div>
                </div>
                </form>
                <hr>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <table class="table table-bordered table-hover" id="tbl_laporan_pemasukan">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Pemasukan</th>
