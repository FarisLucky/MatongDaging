    ...
    <div class="container">
        ...
        <ol class="inner">
            ...
            <li class="">
                <ol>
                <?php  ?>
                    <li class=""><small class="f-14">Tanah Efektif : </small><small class="f-14"><?php echo $rab->tanah_effective ?></small></li>
            ...
            <?php $no++; } ?>
            <li class="mt-2 text-right"><small class="f-14">Total Keseluruhan(Rp) : </small><small class="font-weight"><?= number_format($rab->total_anggaran,2,",",".") ?></small></li>
        </ol>
        
    <div class="absolute">
        <small class="d-inline-block">Pembuat : </small><small class="d-inline-block">&nbsp;<?= $pembuat["nama_lengkap"] ?></small>
    </div>
</body>
