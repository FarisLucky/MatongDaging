...
class PersyaratanKonsumen extends CI_Controller {
    ...
    public function index()
    {
        ...
        $data["persyaratan"] = $this->Mpersyaratan->getData("*","persyaratan_sasaran",["id_kategori_persyaratan"=>1])->result();
        $this->pages("persyaratan/view_syarat_konsumen",$data);
    }
    public function tambah() {
        ...
        $data['js'] = $this->rolemenu->getJavascript(28); //Jangan DIUbah hanya bisa diganti berdasarkan id_dari sub/menu ini !!
        $data['img'] = getCompanyLogo();
        $this->pages("persyaratan/tambah_syarat_konsumen",$data);
    }
    ...
    public function ubah($id) {
        ...
        $this->pages("persyaratan/edit_syarat_konsumen",$data);
    }
